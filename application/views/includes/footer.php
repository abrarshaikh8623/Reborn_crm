...
<div class="sidebar sidebar-right sidebar-animate">
    ...
    <div class="">
        <div class="list-group-item  align-items-center border-0">
            <div class="d-flex">
                <span class="avatar avatar-lg brround mr-3" style="background-image: url(<?= base_url() ?>assets/images/users/4.jpg)"></span>
                <div class="mt-1">
        ...
        <div class="list-group-item  align-items-center  border-bottom">
            <div class="d-flex">
                <span class="avatar avatar-lg brround mr-3" style="background-image: url(<?= base_url() ?>assets/images/users/10.jpg)"></span>
                <div class="mt-1">
        ...
        <div class="list-group-item  align-items-center  border-bottom">
            <div class="d-flex">
                <span class="avatar avatar-lg brround mr-3" style="background-image: url(<?= base_url() ?>assets/images/users/9.jpg)">
        ...
        <div class="list-group-item  align-items-center  border-bottom">
            <div class="d-flex">
                <span class="avatar avatar-lg brround mr-3" style="background-image: url(<?= base_url() ?>assets/images/users/5.jpg)">
        ...
        <div class="list-group-item  align-items-center  border-bottom">
            <div class="d-flex">
                <span class="avatar avatar-lg brround mr-3" style="background-image: url(<?= base_url() ?>assets/images/users/12.jpg)">
                    <span class="avatar-status bg-green"></span>
                </span>
                <div class="mt-1">
                    <a href="#" class="font-weight-semibold fs-16">Vinny<span class="text-muted font-weight-normal"> shared your post</span></a>
        ...
        <div class="list-group-item  align-items-center  border-bottom">
            <div class="d-flex">
                <span class="avatar avatar-lg brround mr-3" style="background-image: url(<?= base_url() ?>assets/images/users/8.jpg)"> </span>
                <div class="mt-1">
        ...
        <div class="list-group-item  align-items-center  border-bottom">
            <div class="d-flex">
                <span class="avatar avatar-lg brround mr-3" style="background-image: url(<?= base_url() ?>assets/images/users/14.jpg)"> </span>
                <div class="mt-1">
        ...
        <div class="list-group-item  align-items-center  border-bottom">
            <div class="d-flex">
                <span class="avatar avatar-lg brround mr-3" style="background-image: url(<?= base_url() ?>assets/images/users/3.jpg)"> </span>
                <div class="mt-1">
...
<script src="<?= base_url() ?>assets/plugins/vertical-scroll/jquery.bootstrap.newsbox.js"></script>
<script src="<?= base_url() ?>assets/plugins/vertical-scroll/vertical-scroll.js"></script>
...
<script src="<?= base_url() ?>assets/plugins/chart.min/chart.min.js"></script>
<script src="<?= base_url() ?>assets/plugins/chart.min/rounded-barchart.js"></script>

<!-- INTERNAL jQuery-countdowntimer js -->
<script src="<?= base_url() ?>assets/plugins/jQuery-countdowntimer/jQuery.countdownTimer.js"></script>
