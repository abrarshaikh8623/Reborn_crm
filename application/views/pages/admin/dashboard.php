            ...
            <div class="col-xl-3 col-lg-3 col-md-3">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-8">
                                <div class="mt-0 text-left"> <span class="fs-14 font-weight-semibold">Total Revenue</span>
            ...
            <div class="col-xl-3 col-lg-3 col-md-3">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-8">
                                <div class="mt-0 text-left"> <span class="fs-14 font-weight-semibold">Orders</span>
                ...
                <!-- <div class="mb-4">
                    ...
                    <ul class="vertical-scroll pt-4 ">
                        <li class="item">
                            <div class="card p-4 ">
                                <div class="d-flex">
                                    <img src="<?= base_url() ?>assets/images/users/16.jpg" alt="img" class="avatar avatar-md bradius mr-3">
                        ...
                        <li class="item">
                            <div class="card p-4 ">
                                <div class="d-flex">
                                    <img src="<?= base_url() ?>assets/images/users/4.jpg" alt="img" class="avatar avatar-md bradius mr-3">
                                    <div class="mr-3 mt-0 mt-sm-1 d-block">
                            ...
                            <table class="table mb-0 text-nowrap">
                                <tbody>
                                    <tr class="border-bottom">
                                        <td>
                                            <div class="d-flex">
                                                <img src="<?= base_url() ?>assets/images/users/16.jpg" alt="img" class="avatar avatar-md brround mr-3">
                                                <div class="mr-3 mt-0 mt-sm-1 d-block">
                                    ...
                                    <tr class="border-bottom">
                                        <td>
                                            <div class="d-flex">
                                                <img src="<?= base_url() ?>assets/images/users/1.jpg" alt="img" class="avatar avatar-md brround mr-3">
                                                <div class="mr-3 mt-0 mt-sm-1 d-block">
                                    ...
                                    <tr class="border-bottom">
                                        <td>
                                            <div class="d-flex">
                                                <img src="<?= base_url() ?>assets/images/users/4.jpg" alt="img" class="avatar avatar-md brround mr-3">
                                                <div class="mr-3 mt-0 mt-sm-1 d-block">
                                    ...
                                    <tr class="border-bottom">
                                        <td>
                                            <div class="d-flex">
                                                <img src="<?= base_url() ?>assets/images/users/8.jpg" alt="img" class="avatar avatar-md brround mr-3">
                                                <div class="mr-3 mt-0 mt-sm-1 d-block">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex">
                                                <img src="<?= base_url() ?>assets/images/users/9.jpg" alt="img" class="avatar avatar-md brround mr-3">
                                                <div class="mr-3 mt-0 mt-sm-1 d-block">
                                                    <h6 class="mb-0">Kimberly Berry</h6>
                                                    <div class="clearfix"></div>
                                                    <small>Senior Prototyper</small>
                                ...
                                <tbody>
                                    ...
                                    <tr class="border-bottom">
                                        <td>
                                            <div class="d-flex">
                                                <div class="table_img brround bg-light mr-3">
                                                    <img src="<?= base_url() ?>assets/images/photos/html.png" alt="img" class=" bg-light brround">
                                                </div>
                                                <div class="mr-3 mt-3 d-block">
                                    ...
                                    <tr class="border-bottom">
                                        <td>
                                            <div class="d-flex">
                                                <div class="table_img brround bg-light mr-3">
                                                    <img src="<?= base_url() ?>assets/images/photos/jquery.png" alt="img" class=" bg-light brround">
                                                </div>
                                                <div class="mr-3 mt-3 d-block">
                                    ...
                                    <tr class="border-bottom">
                                        <td>
                                            <div class="d-flex">
                                                <div class="table_img brround bg-light mr-3">
                                                    <img src="<?= base_url() ?>assets/images/photos/vue.png" alt="img" class=" bg-light brround">
                                                </div>
                                                <div class="mr-3 mt-3 d-block">
